...
*/
	...
	public static long put(Connection conn,String tablename, Put put) throws Exception {
		return put(conn,tablename, Arrays.asList(put));
	}

	public static long put(Connection conn,String tablename, List<Put> puts) throws Exception {
		long currentTime = System.currentTimeMillis();
		final BufferedMutator.ExceptionListener listener = new BufferedMutator.ExceptionListener() {
			@Override
			public void onException(RetriesExhaustedWithDetailsException e, BufferedMutator mutator) {
